...
/* start of image slider imports */
import { Swiper, SwiperSlide } from "swiper/react";
import SwiperCore from "swiper";
import { Navigation } from "swiper/modules";
import "swiper/css/bundle";
/* end of image slider imports */
          ...
          <div>
            ...
            <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
              <p className="text-2xl font-semibold">
                {listing.name} - LKR{" "}
                {listing.type === "rent"
                  ? listing.regularPrice.toLocaleString("en-GB") + " / month"
              ...
              <ul className="text-slate-500 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6">
