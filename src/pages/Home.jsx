    ...
    <div>
      ...
      <div className="flex flex-col gap-6 py-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          PropertyBuy is the best place to find your next perfect place to live.
          <br />
      ...
      <Swiper navigation>
        {offerListings &&
          ...
          offerListings.map((listing) => (
            <SwiperSlide>
              {/* adding style{{}} is essential for Swiper */}
              <div
                style={{
        ...
        {offerListings && offerListings.length > 0 && (
          <div className="">
            <div className="my-3">
              ...
              {/* we want to show more offers when this link is clicked */}
              <Link
